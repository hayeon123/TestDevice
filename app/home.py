...
f = open('/home/ha/test_device/app/dbconfig.json', 'r')
db_config = json.load(f)
f.close()

app = Flask('__name__',  template_folder='/home/ha/test_device/app/templates', static_folder='/home/ha/test_device/app/static')
app.config.from_json('/home/ha/test_device/app/dbconfig.json')
